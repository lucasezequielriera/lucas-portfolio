        ...
        <div className="prose-invert mt-10 space-y-8 text-sm leading-relaxed text-white/65">
          {isEs ? (
            <>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white">4. Condiciones de uso</h2>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white">6. Protección de datos</h2>
                <p>Para más información sobre el tratamiento de datos personales, consulte nuestra <Link href={`/${locale}/privacidad`} className="text-cyan-300 underline">Política de Privacidad</Link>.</p>
              </section>
              <section>
                <h2 className="text-lg font-semibold text-white">7. Legislación aplicable</h2>
            ...
            <>
              <section>
                <h2 className="text-lg font-semibold text-white">1. Identification data</h2>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white">2. Purpose</h2>
                <p>This website aims to present the professional software development and IT consulting services offered by the owner.</p>
              </section>
              <section>
                <h2 className="text-lg font-semibold text-white">3. Intellectual and industrial property</h2>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white">4. Terms of use</h2>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white">6. Data protection</h2>
                <p>For more information about personal data processing, see our <Link href={`/${locale}/privacidad`} className="text-cyan-300 underline">Privacy Policy</Link>.</p>
              </section>
              <section>
                <h2 className="text-lg font-semibold text-white">7. Applicable law</h2>
