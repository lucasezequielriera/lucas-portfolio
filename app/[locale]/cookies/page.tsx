  ...
  return (
    <main id="main-content" className="min-h-screen bg-black text-white">
      <div className="mx-auto max-w-3xl px-6 pb-24 pt-16 md:pt-24">
        ...
        <div className="prose-invert mt-10 space-y-8 text-sm leading-relaxed text-white/65">
          {isEs ? (
            <>
              <section>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white">3. Servicios de terceros</h2>
              ...
              <section>
                ...
                <p>El usuario puede configurar su navegador para rechazar todas o algunas cookies. Tenga en cuenta que deshabilitar la cookie <code className="rounded bg-white/10 px-1.5 py-0.5 text-cyan-300">locale</code> puede afectar a la detección automática del idioma.</p>
              </section>
              <section>
                <h2 className="text-lg font-semibold text-white">5. Más información</h2>
                <p>Para cualquier consulta sobre el uso de cookies, puede contactar a lucasezequielriera@gmail.com. Consulte también nuestra <Link href={`/${locale}/privacidad`} className="text-cyan-300 underline">Política de Privacidad</Link>.</p>
              </section>
            </>
          ) : (
            <>
              ...
              <section>
                ...
                <p>Users can configure their browser to reject all or some cookies. Note that disabling the <code className="rounded bg-white/10 px-1.5 py-0.5 text-cyan-300">locale</code> cookie may affect automatic language detection.</p>
              </section>
              <section>
                <h2 className="text-lg font-semibold text-white">5. More information</h2>
                <p>For any questions about cookie usage, contact lucasezequielriera@gmail.com. See also our <Link href={`/${locale}/privacidad`} className="text-cyan-300 underline">Privacy Policy</Link>.</p>
              </section>
            </>
          )}
        </div>
