        ...
        <div className="prose-invert mt-10 space-y-8 text-sm leading-relaxed text-white/65">
          {isEs ? (
            <>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white">5. Destinatarios</h2>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white">6. Conservación</h2>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white">7. Derechos del usuario</h2>
              ...
              <section>
                ...
                <p>Este sitio web utiliza cookies funcionales. Para más información, consulte nuestra <Link href={`/${locale}/cookies`} className="text-cyan-300 underline">Política de Cookies</Link>.</p>
              </section>
            </>
          ) : (
            <>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white">3. Purpose of processing</h2>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white">4. Legal basis</h2>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white">5. Recipients</h2>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white">7. User rights</h2>
              ...
              <section>
                <h2 className="text-lg font-semibold text-white">9. Cookies</h2>
                <p>This website uses functional cookies. For more information, see our <Link href={`/${locale}/cookies`} className="text-cyan-300 underline">Cookie Policy</Link>.</p>
              </section>
            </>
          )}
        </div>
