...
function getIcon(icon: string | undefined, color: keyof typeof colorStyles) {
  if (icon === "graduation-cap")
    return <GraduationCap className={`h-7 w-7 ${colorStyles[color].icon}`} />;
  if (icon === "palette")
    return <Palette className={`h-7 w-7 ${colorStyles[color].icon}`} />;
  return null;
}
    ...
    <main id="main-content" className="min-h-screen bg-neutral-950 text-neutral-100">
      ...
      <section className="mx-auto max-w-6xl px-6 pb-24 pt-16 md:pt-24">
        ...
        <div className="mt-12 flex flex-wrap gap-4">
          <Link
            href={`/${locale}/proyectos/fit-travel`}
